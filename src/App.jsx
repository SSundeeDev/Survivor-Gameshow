...
function RevealMode({hostName, items, treyPackage, p1, p2, revealedItems, setRevealedItems, soundEnabled}) {
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column'}}>
      ...
      {/* Filter row 2 — categories (their own full-width lane) */}
      <div style={{
        background: NAVY_DARK,
        padding: '8px 24px',
        borderBottom: '1px solid rgba(168,197,232,0.04)',
        display: 'flex',
        alignItems: 'center',
        gap: 12,
        flexShrink: 0,
      ...
      {/* Filter row 3 — search + reveal controls */}
      <div style={{
        background: NAVY_DARK,
        ...
        <button onClick={resetReveals} className="tra-mono" style={{padding: '5px 10px', background: 'transparent', border: '1px solid rgba(168,197,232,0.3)', color: 'rgba(168,197,232,0.7)', fontSize: 9, letterSpacing: '0.15em', cursor: 'pointer', whiteSpace: 'nowrap'}}>
          RESET REVEALS
        </button>
        <button onClick={revealAll} className="tra-mono" style={{padding: '5px 10px', background: 'rgba(201,182,131,0.15)', border: `1px solid ${GOLD}`, color: GOLD, fontSize: 9, letterSpacing: '0.15em', cursor: 'pointer', whiteSpace: 'nowrap'}}>
          REVEAL ALL
        </button>
      </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${revealed ? 'rgba(201,182,131,0.4)' : 'rgba(168,197,232,0.15)'}`,
                    borderLeft: `3px solid ${revealed ? GOLD : 'rgba(168,197,232,0.15)'}`,
                    cursor: 'pointer',
                    transition: 'all 0.15s',
                    userSelect: 'none',
                    position: 'relative',
...
function ScorePanel({name, score, color, isWinner, isTie, flash}) {
  return (
    <div
      ...
      style={{
        padding: isWinner ? '34px 28px 20px' : '20px 28px',
        background: isWinner
